...
let arid = {
	1: `https://d8aspring.post-survey.com/ans/back/?key=3ppRUPgL&status=comp&uid=${nid}`,
	2: `https://d8aspring.post-survey.com/ans/back/?key=3ppRUPgL&status=scrout&uid=${nid}`,
	3: `https://d8aspring.post-survey.com/ans/back/?key=3ppRUPgL&status=quotafull&uid=${nid}`
};
