...
let arid = {
	1: `https://d8aspring.post-survey.com/ans/back/?key=fHpo6oTD&status=comp&uid=${nid}`,
	2: `https://d8aspring.post-survey.com/ans/back/?key=fHpo6oTD&status=scrout&uid=${nid}`,
	3: `https://d8aspring.post-survey.com/ans/back/?key=fHpo6oTD&status=quotafull&uid=${nid}`
};
