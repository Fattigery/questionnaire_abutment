...
let app = {
	1: `https://api.catpanel.cn/business/renwu/design/call/otherSuccessUrl?surveyId=1008037827310518272&uid=${nid}`,
	2: `https://api.catpanel.cn/business/renwu/design/call/otherFailUrl?surveyId=1008037827310518272&uid=${nid}`,
	3: `https://api.catpanel.cn/business/renwu/design/call/otherQuotaFull?surveyId=1008037827310518272&uid=${nid}`
};
