...
let arid = {
	1: `https://d8aspring.post-survey.com/ans/back/?key=yLkH7WWA&status=comp&uid=${nid}`,
	2: `https://d8aspring.post-survey.com/ans/back/?key=yLkH7WWA&status=scrout&uid=${nid}`,
	3: `https://d8aspring.post-survey.com/ans/back/?key=yLkH7WWA&status=quotafull&uid=${nid}`
};
