...
let arid = {
	1: `https://d8aspring.post-survey.com/ans/back/?key=2fZAGKnF&status=comp&uid=${nid}`,
	2: `https://d8aspring.post-survey.com/ans/back/?key=2fZAGKnF&status=scrout&uid=${nid}`,
	3: `https://d8aspring.post-survey.com/ans/back/?key=2fZAGKnF&status=quotafull&uid=${nid}`
};
