...
let arid = {
	1: `https://infopanel.jp/lpark/enqInfoUpdateForNC.do?status=1&id=${nid}`,
	2: `https://infopanel.jp/lpark/enqInfoUpdateForNC.do?status=2&id=${nid}`,
	3: `https://infopanel.jp/lpark/enqInfoUpdateForNC.do?status=3&id=${nid}`
};
