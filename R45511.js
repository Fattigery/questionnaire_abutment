...
let app = {
	1: `https://api.catpanel.cn/business/renwu/design/call/otherSuccessUrl?surveyId=994551517098803200&uid=${nid}`,
	2: `https://api.catpanel.cn/business/renwu/design/call/otherFailUrl?surveyId=994551517098803200&uid=${nid}`,
	3: `https://api.catpanel.cn/business/renwu/design/call/otherQuotaFull?surveyId=994551517098803200&uid=${nid}`
};
